 ...
 * @author user
 */
public class RegistrationFormd extends javax.swing.JFrame {

    /**
     * Creates new form RegistrationForm
     */
    public RegistrationFormd() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Back.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        kGradientPanel1.add(Back);
        Back.setBounds(140, 650, 140, 40);
    ...
    private void BackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BackMouseClicked
        ...
        AdminHome reg=new AdminHome("admin");
        reg.setVisible(true);
    ...
    private void BackMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BackMouseExited
        // TODO add your handling code here:
        Back.setBackground(new Color(153,51,255));
        ...
        else
        {
          ...
          // java.util.Date date = new java.util.Date();
            ...
            if(regAs=="Driver")
            {
                ...
                Admin aa=new Admin();
                String as=aa.insertdriver("{call insertdriver(?,?,?,?,?,?,?,?,?)}",name , fName, age, dob, gender, cnic, contactNo, user, pass);
                if(as.equals("ok"))
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationFormd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationFormd().setVisible(true);
            }
        });
    }
