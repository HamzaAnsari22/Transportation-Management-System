...
public class LoginMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LoginAsCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Admin", "Passenger", "Driver" }));
        ...
        TextPass.setBounds(910, 420, 270, 30);
        ...
        jLabel5.setText("All rights reserved, Hamza Ansari");
        ...
        jPanel1.setBounds(1180, 10, 91, 30);
    ...
    private void LoginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoginButtonMouseClicked
        ...
        else
        {
            ...
            if(LoginAs=="Admin")
            {
                if(iidd.equals("admin")&&pass.equals("admin"))
                {
            ...
            else if(LoginAs.equals("Driver"))
            {
                int asd=0;
                Admin aa=new Admin();
               asd= aa.checkcred("{call checkcred(?,?,?)}", iidd, pass);
                if(asd==0)
                {
                    System.out.println(iidd+" "+pass);
                    JOptionPane.showMessageDialog(null, "Invalid UserID or Password");
                ...
                {
                   // String qwe=""+asd;
                    driverhomee dd=new driverhomee(asd);
                    this.hide();
                    dd.show();
                }
            ...
            else if(LoginAs=="Passenger")
            {
                    int asd=0;
                Admin aa=new Admin();
               asd= aa.checkpcred("{call checkpcred(?,?,?)}", iidd, pass);
                if(asd==0)
                {
                    System.out.println(iidd+" "+pass);
                    JOptionPane.showMessageDialog(null, "Invalid UserID or Password");
                ...
                {
                   // String qwe=""+asd;
                    PassengerHome dd=new PassengerHome(asd);
                    this.hide();
                    dd.show();
                }
...
//                    String fname=passing.getfName1();
//                    String age=passing.getAge1();
//                    String contact=passing.getContactNo1();
//                    String cnic=passing.getCnic1();
//                    String dob=passing.getDob1();
//                    String email=passing.getSec1();
//                    
//                    PassengerHome ph=new PassengerHome(iidd,pname,fname,age,cnic,contact,dob,email);
